...
public class LogginScreen extends JFrame {
	...
	private JMenuItem mnitmAyuda = new JMenuItem("Ayuda");
	...
	public LogginScreen() {
		...
		try {
			...
			broker.enableHelpOnButton(mnitmAyuda, "LogginScreen", helpset);
			broker.enableHelpKey(getRootPane(), "Menu", helpset);
		...
		mnAyuda.setName("mnAyuda"); //$NON-NLS-1$
		menuBar.add(mnAyuda);
		...
		txtemail.setText("Marcy Wu"); //$NON-NLS-1$
		...
		txtpasswd.setText("asd"); //$NON-NLS-1$
